...
public class QueryBuilder
{
	...
	private void processFields(FieldProcessor processor,List<String> columns,List<Object> params,StringBuilder placeholders)
	{
		try
		{
			FieldMeta fieldMeta;
	...
	public Query buildInsertQuery()
	{
		...
		processFields(insertProcessor,columns,params,placeHolder);
